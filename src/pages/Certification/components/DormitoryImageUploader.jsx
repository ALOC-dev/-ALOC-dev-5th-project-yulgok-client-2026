function DormitoryImageUploader({ imageUrl, onChange }) {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <label className="flex h-[34px] w-2/5 self-center cursor-pointer items-center justify-center rounded-full border border-brand-primary bg-white px-3 text-xs font-bold text-brand-primary shadow-sm transition-colors hover:bg-brand-primary/5 active:bg-brand-primary/10 focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-brand-primary">
